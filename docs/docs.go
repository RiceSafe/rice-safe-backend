...
const docTemplate = `{
        ...
        "/outbreaks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "Filter only verified outbreaks (Farmer only)",
                        "name": "verified",
                        "in": "query"
                    },
                    {
        ...
        "/users": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by role (FARMER, EXPERT, ADMIN)",
                        "name": "role",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_auth.UserListItem"
                            }
                        }
                    },
                    "403": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_auth.UpdateRoleRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_auth.UpdateRoleRequest": {
            "type": "object",
            "required": [
                "role"
            ],
